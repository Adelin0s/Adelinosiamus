...
DWORD CPythonExchange::GetItemNameFromTarget(DWORD pos)
{
	return 0;
}
DWORD CPythonExchange::GetItemNameFromSelf(DWORD pos)
{
	return 0;
}
#endif
...
DWORD CPythonExchange::GetItemCountFromTarget(DWORD pos)
{
	if (pos >= EXCHANGE_ITEM_MAX_NUM)
		return 0;
...
DWORD CPythonExchange::GetItemCountFromSelf(DWORD pos)
{
	if (pos >= EXCHANGE_ITEM_MAX_NUM)
		return 0;
