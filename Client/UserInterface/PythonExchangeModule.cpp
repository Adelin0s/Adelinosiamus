...
{
	int64_t llGold = CPythonExchange::Instance().GetElkFromSelf();
	return PyLong_FromLongLong(llGold);
}

PyObject * exchangeGetElkFromTarget(PyObject * poSelf, PyObject * poArgs)
{
	int64_t llGold = CPythonExchange::Instance().GetElkFromTarget();
	return PyLong_FromLongLong(llGold);
}
...
PyObject * exchangeGetItemCountFromSelf(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("i", CPythonExchange::Instance().GetItemCountFromSelf(pos));
}
...
PyObject * exchangeGetItemCountFromTarget(PyObject * poTarget, PyObject * poArgs)
{
	...
	return Py_BuildValue("i", CPythonExchange::Instance().GetItemCountFromTarget(pos));
}
...
PyObject* exchangeGetItemNameFromTarget(PyObject* poTarget, PyObject* poArgs)
{
	int pos;
	...
	return Py_BuildValue("I", CPythonExchange::Instance().GetItemNameFromTarget((DWORD) pos));
}

PyObject* exchangeGetItemNameFromSelf(PyObject* poTarget, PyObject* poArgs)
{
	int pos;
	...
	return Py_BuildValue("I", CPythonExchange::Instance().GetItemNameFromSelf((DWORD)pos));
}
