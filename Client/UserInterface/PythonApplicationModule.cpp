...
PyObject* appGetClientVersion(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CAccountConnector::Instance().GetExeVersion());
}
#endif
...
void initapp()
{
...
#ifdef __VERSION__
		{ "GetClientVersion",			appGetClientVersion,			METH_VARARGS},
#endif
#ifdef ENABLE_MULTI_FARM_BLOCK
...
#ifdef SAVE_WHISPER
	PyModule_AddIntConstant(poModule, "SAVE_WHISPER", 1);
#else
	PyModule_AddIntConstant(poModule, "SAVE_WHISPER", 0);
#endif
...
#ifdef __SASH_SKIN__
	PyModule_AddIntConstant(poModule, "__SASH_SKIN__", 1);
#else
	PyModule_AddIntConstant(poModule, "__SASH_SKIN__", 0);
#endif
...
#ifdef ENABLE_RENEWAL_AFFECT_SHOWER
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_AFFECT_SHOWER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_AFFECT_SHOWER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__SAVE_BLOCK_ATTR__", 1);
#else
	PyModule_AddIntConstant(poModule, "__SAVE_BLOCK_ATTR__", 0);
#endif

#ifdef __LOBBY_MAP_VISIBILITY__
	PyModule_AddIntConstant(poModule, "__LOBBY_MAP_VISIBILITY__", 1);
#else
	PyModule_AddIntConstant(poModule, "__LOBBY_MAP_VISIBILITY__", 0);
#endif
...
#ifdef __VERSION__
	PyModule_AddIntConstant(poModule, "__VERSION__", 1);
#else
	PyModule_AddIntConstant(poModule, "__VERSION__", 0);
#endif
...
#ifdef KEEP_DRAGON_BEAN
	PyModule_AddIntConstant(poModule, "KEEP_DRAGON_BEAN", 1);
#else
	PyModule_AddIntConstant(poModule, "KEEP_DRAGON_BEAN", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__RENEWAL_CRYSTAL__", 1);
#else
	PyModule_AddIntConstant(poModule, "__RENEWAL_CRYSTAL__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__PERMA_ACCESSORY__", 1);
#else
	PyModule_AddIntConstant(poModule, "__PERMA_ACCESSORY__", 0);
#endif

#ifdef __TIME_STACKEBLE__
	PyModule_AddIntConstant(poModule, "__TIME_STACKEBLE__", 1);
#else
	PyModule_AddIntConstant(poModule, "__TIME_STACKEBLE__", 0);
#endif

#if defined(__BL_EVENT_STONE_SHAPE_CHANGE__)
	PyModule_AddIntConstant(poModule, "__BL_EVENT_STONE_SHAPE_CHANGE__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_EVENT_STONE_SHAPE_CHANGE__", false);
#endif

#ifdef __PENDANT__
	PyModule_AddIntConstant(poModule, "__PENDANT__", 1);
#else
	PyModule_AddIntConstant(poModule, "__PENDANT__", 0);
#endif
