...
class CPythonPlayer : public CSingleton<CPythonPlayer>, public IAbstractPlayer
{
	...
	public:
		...
		bool	IsSwitchInventorySlot(TItemPos Cell);
		bool	IsCostumeInventorySlot(TItemPos Cell);
#endif
		...
		// Quickslot
		int		GetQuickPage();
		void	SetQuickPage(DWORD nPageIndex);
		void	AddQuickSlot(DWORD QuickslotIndex, DWORD IconType, DWORD IconPosition);
		void	DeleteQuickSlot(DWORD QuickslotIndex);
		void	MoveQuickSlot(DWORD Source, DWORD Target);
