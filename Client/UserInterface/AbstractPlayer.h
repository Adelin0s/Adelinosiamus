...
class IAbstractPlayer : public TAbstractSingleton<IAbstractPlayer>
{
	public:
		...
		virtual void	AddQuickSlot(DWORD QuickslotIndex, DWORD IconType, DWORD IconPosition) = 0;
		virtual void	DeleteQuickSlot(DWORD QuickslotIndex) = 0;
		virtual void	MoveQuickSlot(DWORD Source, DWORD Target) = 0;
