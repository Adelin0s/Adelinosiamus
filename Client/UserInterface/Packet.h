...
enum EPointTypes
{
	...
	POINT_PARTY_BUFFER_BONUS = 103,		// 103
	POINT_PARTY_SKILL_MASTER_BONUS = 104,	// 104
	...
	POINT_GEM,
#endif
	POINT_INVENTORY,			// fixed !!!
	POINT_SKILL_INVENTORY,		// fixed !!!
	POINT_MATERIAL_INVENTORY,	// fixed !!!
	POINT_STONE_INVENTORY,		// fixed !!!
	POINT_CHEST_INVENTORY,		// fixed !!!
	POINT_ENCHANT_INVENTORY,	// fixed !!!
	POINT_COSTUME_INVENTORY,	// fixed !!!
