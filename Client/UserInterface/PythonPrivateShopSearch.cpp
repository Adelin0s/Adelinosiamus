...
PyObject* privateShopSearchGetSearchOwnerStatus(PyObject* poSelf, PyObject* poArgs)
{
	int ipos;
	if (!PyTuple_GetInteger(poArgs, 0, &ipos))
		return Py_BadArgument();
	...
	return Py_BuildValue("i", pInstance->ownerStatus);
}

PyObject* privateShopSearchGetSearchAveragePrice(PyObject* poSelf, PyObject* poArgs)
{
	int ipos;
	if (!PyTuple_GetInteger(poArgs, 0, &ipos))
		return Py_BadArgument();
	...
	return Py_BuildValue("i", pInstance->averagePrice);
}
...
void initprivateShopSearch()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetSearchOwnerStatus", privateShopSearchGetSearchOwnerStatus, METH_VARARGS },
		{ "GetSearchAveragePrice", privateShopSearchGetSearchAveragePrice, METH_VARARGS },
		{ NULL,							NULL,									NULL },
	};
