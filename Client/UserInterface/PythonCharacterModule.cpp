...
PyObject* chrIsMain(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsMainInstance());
}
...
PyObject* chrGetLevel(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", pCharacterInstance->GetLevel());
}
...
PyObject* chrIsAttacking(PyObject* poSelf, PyObject* poArgs)
{
	CInstanceBase* pkInst = CPythonCharacterManager::Instance().GetMainInstancePtr();
	if (!pkInst)
		return Py_BuildNone();

	return Py_BuildValue("i", pkInst->IsAttacking());
}
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "IsMainCharacter",			chrIsMain,							METH_VARARGS },
...
#endif
		{ "IsAttacking",				chrIsAttacking,						METH_VARARGS },
...
#endif
	PyModule_AddIntConstant(poModule, "AFFECT_LEADERSHIP",					CInstanceBase::AFFECT_LEADERSHIP);
...
#endif
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PARTY",					CInstanceBase::AFFECT_PARTY);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_NAME_MOUNT",					CInstanceBase::AFFECT_NAME_MOUNT);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_NAME_PET",					CInstanceBase::AFFECT_NAME_PET);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_ATT_WATER", CInstanceBase::AFFECT_ATT_WATER);
	PyModule_AddIntConstant(poModule, "AFFECT_DEF_WATER", CInstanceBase::AFFECT_DEF_WATER);
#endif

#ifdef __RENEWAL_CRYSTAL__
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_CRYSTAL", CInstanceBase::NEW_AFFECT_CRYSTAL);
#endif
