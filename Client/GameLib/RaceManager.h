...
class CRaceManager : public CSingleton<CRaceManager>
{
	...
	private:
		bool							m_bValentineStoneShapeState;
		bool							m_bIceCreamStoneShapeState;
		bool							m_bRamadanStoneShapeState;
		bool							m_bYutnoriStoneShapeState;
		bool							m_bFootballStoneShapeState;
	
	public:
		void							SetValentineStoneShapeState(bool bEnabled);
		void							SetIceCreamStoneShapeState(bool bEnabled);
		void							SetRamadanStoneShapeState(bool bEnabled);
		void							SetYutnoriStoneShapeState(bool bEnabled);
		void							SetFootballStoneShapeState(bool bEnabled);
	
		bool							GetValentineStoneShapeState() const;
		bool							GetIceCreamStoneShapeState() const;
		bool							GetRamadanStoneShapeState() const;
		bool							GetYutnoriStoneShapeState() const;
		bool							GetFootballStoneShapeState() const;
#endif
};
