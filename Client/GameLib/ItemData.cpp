...
void CItemData::SetSummary2(const std::string& c_rstSumm)
{
	m_strSummary2 = c_rstSumm;
}

void CItemData::SetSummary3(const std::string& c_rstSumm)
{
	m_strSummary3 = c_rstSumm;
}

void CItemData::SetSummary4(const std::string& c_rstSumm)
{
	m_strSummary4 = c_rstSumm;
}
...
const char* CItemData::GetSummary2() const
{
	return m_strSummary2.c_str();
}

const char* CItemData::GetSummary3() const
{
	return m_strSummary3.c_str();
}

const char* CItemData::GetSummary4() const
{
	return m_strSummary4.c_str();
}
