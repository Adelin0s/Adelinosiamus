...
void CRaceManager::__Initialize()
{
	...
	m_bValentineStoneShapeState = false;
	m_bIceCreamStoneShapeState = false;
	m_bRamadanStoneShapeState = false;
	m_bYutnoriStoneShapeState = false;
	m_bFootballStoneShapeState = false;
#endif
}
...
#if defined(__BL_EVENT_STONE_SHAPE_CHANGE__)
void CRaceManager::SetValentineStoneShapeState(bool bEnabled)
{
	m_bValentineStoneShapeState = bEnabled;
}

void CRaceManager::SetIceCreamStoneShapeState(bool bEnabled)
{
	m_bIceCreamStoneShapeState = bEnabled;
}

void CRaceManager::SetRamadanStoneShapeState(bool bEnabled)
{
	m_bRamadanStoneShapeState = bEnabled;
}

void CRaceManager::SetYutnoriStoneShapeState(bool bEnabled)
{
	m_bYutnoriStoneShapeState = bEnabled;
}

void CRaceManager::SetFootballStoneShapeState(bool bEnabled)
{
	m_bFootballStoneShapeState = bEnabled;
}

bool CRaceManager::GetValentineStoneShapeState() const
{
	return m_bValentineStoneShapeState;
}

bool CRaceManager::GetIceCreamStoneShapeState() const
{
	return m_bIceCreamStoneShapeState;
}

bool CRaceManager::GetRamadanStoneShapeState() const
{
	return m_bRamadanStoneShapeState;
}

bool CRaceManager::GetYutnoriStoneShapeState() const
{
	return m_bYutnoriStoneShapeState;
}

bool CRaceManager::GetFootballStoneShapeState() const
{
	return m_bFootballStoneShapeState;
}
#endif
